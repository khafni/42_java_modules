...
public class UsersRepositoryJdbcTemplateImpl implements UsersRepository{
    ...
    private static final String SQL_INSERT = "INSERT INTO users (email) VALUES (:email) RETURNING id";
    ...
    public void save(User entity) {
        ...
        Long generatedId = namedTemplate.queryForObject(SQL_INSERT, params, Long.class);
