...
public class UsersServiceImpl implements UsersService {
    ...
    @Override
    public void updateLastChatroom(User user, Chatroom chatroom) {
        user.setLastChatroom(chatroom);
        usersRepository.updateLastChatroom(user.getId(), chatroom != null ? chatroom.getId() : null);
    }
}
